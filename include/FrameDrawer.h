...
public:
    ...
    // cv::Mat DrawFailedBlocks(cv::Mat &im, Tracking *pTracker);
    cv::Mat DrawORBPoints(cv::Mat &im, Tracking *pTracker);

    // Get Matched KeyPoints
    vector<cv::KeyPoint> Keys();
    vector<cv::KeyPoint> mvMatchedKPs;
...
protected:
    ...
    vector<bool> mvbDense, mvbLowEntropy;
    bool mbOnlyTracking;
