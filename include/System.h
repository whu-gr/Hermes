...
public:
    ...
    void SaveTrajectoryICL(const string &filename);
    void SaveKeyFrameTimeStamp(const string &filename);
    ...
    void SaveTrajectoryTartanAir(const string &filename);
    void SaveKFsMPs(const string &filename);
