...
int main(int argc, char **argv)
{
    if(argc != 5)
    {
        cerr << endl << "Usage: ./stereo_kitti path_to_vocabulary path_to_settings path_to_sequence path_to_save_folder" << endl;
        return 1;
    }
    ...
    string save_folder = argv[4];
    SLAM.SaveTrajectoryTartanAir(save_folder + "/CameraTrajectoryV44.txt");
    SLAM.SaveKeyFrameTimeStamp(save_folder + "/TimeStampV44.txt");
    SLAM.SaveKFsMPs(save_folder + "/KFsMPsV44.txt");
                ...
                vector<string> &vstrImageRight, vector<double> &vTimestamps)
{
    ...
    string strPrefixRight = strPathToSequence + "/image_right/";
